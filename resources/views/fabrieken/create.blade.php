    ...
    <div class="container">
        <div class="card">
            <div class="card-header text-center">
                <h3>Voeg fabriek toe</h3>
            </div>
            <div class="card-body">
                <form action="/fabrieken/store" method="post">
                    @csrf
                    ...
                    <div class="form-group row text-center">
                        ...
                        <div class="col-md-4">
                            <input type="tel" id="telefoon" name="telefoon" class="form-control @error('telefoon') is-invalid @enderror" value="{{ old('telefoon') }}" autofocus>
